...
export enum PropertyCode {
    ...
    AttackRating = "att",
    AttackRatingPerLevel = "att/lvl",
    AttackRatingPercent = "att%",
    AttackRatingPercentPerLevel = "att%/lvl",
    AttackRatingVsDemons = "att-demon",
    AttackRatingVsDemonsPerLevel = "att-dem/lvl",
    AttackRatingVsUndead = "att-undead",
    AttackRatingVsUndeadPerLevel = "att-und/lvl",
